...
X_train, X_test, y_train, y_test = train_test_split(
    data_inputs, data_outputs, test_size=0.25
)
...
logger.info(
    "batch_size: {} num_classes: {} epochs: {} ".format(batch_size, num_classes, epochs)
)
...
logger.info(
    "Elapsed time :{} Test loss: {} Test accuracy: {}".format(
        elapsed_time, score[0], score[1]
    )
)
